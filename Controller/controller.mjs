export default class Controller {
  ...
  init() {
    ...
    this.view.buttonDelAll.addEventListener("click", () => {// удаляем все таски
  ...
  render() {
    ...
    this.model.array.forEach((el, index) => {//корректировка
      ...
      //сохраняем откорректированную таску
